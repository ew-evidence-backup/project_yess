...
<html xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraphprotocol.org/schema/">
    <head>
      <title>Facebook Invite All Friends PHP class</title>
       <meta name="description" content="PHP Example of creting Facebook All Friends using the Graph API." />
       <link rel="stylesheet" type="text/css" href="faceconn/faceconn.css" />
                                ...
                                <form id="form1" action="#">
                                    <div class="contentdiv">
                                       ...
                                       <p style="text-align: justify">
                                        ...
                                        <b><a href="http://faceconn.com/facebook-invite-friends-php">Facebook Invite All Friends Tutorial</a></b>.
                                        <br /><br />
                                        </p>

                                        <?php
                                            // create instance of request dialog cotrols
                                            $request = new InviteAllFriends();
                                            ...
                                            // Optional: set command text
                                            $request->SetCommandText("Invite All Friends");
                                            ...
                                            if (isset($_GET["invitedFriends"])) {
                                                $invitedFriends = $_GET["invitedFriends"];
                                                $invitedFriends = str_replace(",", ", ", $invitedFriends);
                                                echo "<br /><br />Invited Friends IDs = " . $invitedFriends;
                                            }
                                        ?>
                                        <br /><br />
                                    </div>
