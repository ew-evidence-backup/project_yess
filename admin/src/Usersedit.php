...
class cUsers_edit extends cUsers {
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->Created->EditValue = ew_FormatDateTime($this->Created->EditValue, 5);
			$this->Created->ViewCustomAttributes = "";
...
fUsersedit.Lists["x_Type"] = {"LinkField":"x_UserTypeID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php echo $Users->Created->EditValue ?></span>
</span>
<input type="hidden" data-field="x_Created" name="x_Created" id="x_Created" value="<?php echo ew_HtmlEncode($Users->Created->CurrentValue) ?>">
...
<script type="text/javascript">
fUsersedit.Lists["x_Type"].Options = <?php echo (is_array($Users->Type->EditValue)) ? ew_ArrayToJson($Users->Type->EditValue, 1) : "[]" ?>;
</script>
</span>
