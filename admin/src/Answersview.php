...
$Answers_view = NULL; // Initialize page object first

class cAnswers_view extends cAnswers {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["AnswerID"] <> "") {
			$this->RecKey["AnswerID"] = $_GET["AnswerID"];
			$KeyUrl .= "&amp;AnswerID=" . urlencode($this->RecKey["AnswerID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["AnswerID"] <> "") {
				...
				$this->RecKey["AnswerID"] = $this->AnswerID->QueryStringValue;
			} else {
				$sReturnUrl = "Answerslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "Answerslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "Answerslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($Answers_view)) $Answers_view = new cAnswers_view();

// Page init
$Answers_view->Page_Init();

// Page main
$Answers_view->Page_Main();
...
// Page object
var Answers_view = new ew_Page("Answers_view");
Answers_view.PageID = "view"; // Page ID
var EW_PAGE_ID = Answers_view.PageID; // For backward compatibility

// Form object
var fAnswersview = new ew_Form("fAnswersview");

// Form_CustomValidate event
fAnswersview.Form_CustomValidate = 
...
fAnswersview.ValidateRequired = true;
<?php } else { ?>
fAnswersview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fAnswersview.Lists["x_ID"] = {"LinkField":"x_ID","Ajax":null,"AutoFill":false,"DisplayFields":["x__Email","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if (!$Answers_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($Answers_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
...
?>
<form name="fAnswersview" id="fAnswersview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="Answers">
<table class="ewGrid"><tr><td>
<table id="tbl_Answersview" class="table table-bordered table-striped">
...
<?php echo $Answers->AnswerID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $Answers->Answer->ViewAttributes() ?>>
<?php echo $Answers->Answer->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Answers->lastModified->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Answers->Date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Answers->ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
