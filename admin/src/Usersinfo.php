...
class cUsers extends cTable {
	...
	function __construct() {
		...
		// Created
		$this->Created = new cField('Users', 'Users', 'x_Created', 'Created', '`Created`', 'DATE_FORMAT(`Created`, \'%Y/%m/%d\')', 135, 5, FALSE, '`Created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Created->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['Created'] = &$this->Created;

		// Type
		$this->Type = new cField('Users', 'Users', 'x_Type', 'Type', '`Type`', '`Type`', 3, -1, FALSE, '`Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
