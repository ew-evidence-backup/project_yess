...
fUserslist.Lists["x_Type"] = {"LinkField":"x_UserTypeID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($Users->Created->Visible) { // Created ?>
	<?php if ($Users->SortUrl($Users->Created) == "") { ?>
		<td><div id="elh_Users_Created" class="Users_Created"><div class="ewTableHeaderCaption"><?php echo $Users->Created->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $Users->SortUrl($Users->Created) ?>',1);"><div id="elh_Users_Created" class="Users_Created">
