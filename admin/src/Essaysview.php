...
$Essays_view = NULL; // Initialize page object first

class cEssays_view extends cEssays {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["EssayID"] <> "") {
			$this->RecKey["EssayID"] = $_GET["EssayID"];
			$KeyUrl .= "&amp;EssayID=" . urlencode($this->RecKey["EssayID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["EssayID"] <> "") {
				...
				$this->RecKey["EssayID"] = $this->EssayID->QueryStringValue;
			} else {
				$sReturnUrl = "Essayslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "Essayslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "Essayslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($Essays_view)) $Essays_view = new cEssays_view();

// Page init
$Essays_view->Page_Init();

// Page main
$Essays_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$Essays_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var Essays_view = new ew_Page("Essays_view");
Essays_view.PageID = "view"; // Page ID
var EW_PAGE_ID = Essays_view.PageID; // For backward compatibility

// Form object
var fEssaysview = new ew_Form("fEssaysview");

// Form_CustomValidate event
fEssaysview.Form_CustomValidate = 
...
fEssaysview.ValidateRequired = true;
<?php } else { ?>
fEssaysview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fEssaysview.Lists["x_TopicID"] = {"LinkField":"x_TopicID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $Essays_view->ExportOptions->Render("body") ?>
<?php if (!$Essays_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($Essays_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $Essays_view->ShowPageHeader(); ?>
<?php
$Essays_view->ShowMessage();
?>
<form name="fEssaysview" id="fEssaysview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="Essays">
<table class="ewGrid"><tr><td>
<table id="tbl_Essaysview" class="table table-bordered table-striped">
...
<?php echo $Essays->EssayID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Essays->TopicID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Essays->DateModified->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Essays->Date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
