...
define("EW_PROJECT_NAME", "yessey", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{A1E1A318-A966-4120-A8D8-F8227648CCB2}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '1h6dmSlRhrW7wKhe', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/yessey.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", '192.254.253.80', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'econline_yessay', TRUE);
define("EW_CONN_PASS", 'evin337887', TRUE);
define("EW_CONN_DB", 'econline_yessay', TRUE);
...
define("EW_ADMIN_PASSWORD", "y3ss3y!", TRUE); // Administrator password
