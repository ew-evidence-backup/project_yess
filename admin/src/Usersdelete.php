...
fUsersdelete.Lists["x_Type"] = {"LinkField":"x_UserTypeID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($Users->Created->Visible) { // Created ?>
		<td><span id="elh_Users_Created" class="Users_Created"><?php echo $Users->Created->FldCaption() ?></span></td>
<?php } ?>
...
<span id="el<?php echo $Users_delete->RowCnt ?>_Users_Created" class="control-group Users_Created">
