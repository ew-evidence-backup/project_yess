...
$Videos_view = NULL; // Initialize page object first

class cVideos_view extends cVideos {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["VideoID"] <> "") {
			$this->RecKey["VideoID"] = $_GET["VideoID"];
			$KeyUrl .= "&amp;VideoID=" . urlencode($this->RecKey["VideoID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["VideoID"] <> "") {
				...
				$this->RecKey["VideoID"] = $this->VideoID->QueryStringValue;
			} else {
				$sReturnUrl = "Videoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "Videoslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "Videoslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($Videos_view)) $Videos_view = new cVideos_view();

// Page init
$Videos_view->Page_Init();

// Page main
$Videos_view->Page_Main();
...
// Page object
var Videos_view = new ew_Page("Videos_view");
Videos_view.PageID = "view"; // Page ID
var EW_PAGE_ID = Videos_view.PageID; // For backward compatibility

// Form object
var fVideosview = new ew_Form("fVideosview");
...
fVideosview.ValidateRequired = true;
<?php } else { ?>
fVideosview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fVideosview.Lists["x_VideoCategory"] = {"LinkField":"x_VideoCategory","Ajax":null,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if (!$Videos_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fVideosview" id="fVideosview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="Videos">
<table class="ewGrid"><tr><td>
<table id="tbl_Videosview" class="table table-bordered table-striped">
...
<?php echo $Videos->VideoID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $Videos->Path->ViewAttributes() ?>>
<?php echo $Videos->Path->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Videos->DateModified->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Videos->Date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $Videos->VideoCategory->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
